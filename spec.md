...
* **管理员审核：** 管理员在后台审核车辆信息，可以：
  - 拒绝交易并给出理由（通知卖家）
  - 提出若干（>=1）个管理员有空闲的时间段
* **卖家选择时间段：** 卖家收到通知，从管理员提供的时间段中选择一个
...
### 4.7 私信系统
* **管理员与用户私信：** 管理员可以主动联系卖家或买家，用户也可以联系管理员
* **留言形式：** 私信以留言形式保存，非实时聊天
* **查看方式：** 在个人中心查看私信记录

### 4.8 主页增强模块
* **交易倒计时：** 显示用户和管理员已选择时间段的交易倒计时，若未选择时间段则显示有待完成的交易
